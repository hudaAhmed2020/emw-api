...
//                                                        
var end = draw2d.SetFigure.extend({            
    ...
    init:function(attr, setter, getter)
    {
      ...
      var port;
      // Port
      port = this.addPort(new DecoratedInputPort(), new draw2d.layout.locator.XYRelPortLocator(47.59698275862069, 0.8620689655172413));
    ...
    createSet: function()
    {
        this.canvas.paper.setStart();
         ...
         // Label
         shape = this.canvas.paper.text(0,0,'end');
         shape.attr({"x":50.65625,"y":29,"text-anchor":"start","text":"End","font-family":"\"Arial\"","font-size":22,"stroke":"none","fill":"#FFFFFF","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
